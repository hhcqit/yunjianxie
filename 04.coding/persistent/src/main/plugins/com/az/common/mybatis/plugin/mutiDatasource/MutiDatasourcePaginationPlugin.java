package com.az.common.mybatis.plugin.mutiDatasource;
...
public class MutiDatasourcePaginationPlugin extends PluginAdapter {
	private String pageClass = "com.az.common.vo.mybatis.pagination.Page";

	@Override
	public void setProperties(Properties properties) {
		super.setProperties(properties);
		String pageClass = this.properties.getProperty("pageClass");
		if (StringUtility.stringHasValue(pageClass)) {
	...
	public boolean sqlMapDocumentGenerated(Document document,
		...
		pageStart.addAttribute(new Attribute("test",
				"page != null and _databaseId == 'oracle'"));
		...
		pageEnd.addAttribute(new Attribute("test",
				"page != null and _databaseId == 'oracle'"));
		...
		oraclePage.addAttribute(new Attribute("test",
				"page != null and _databaseId == 'mysql'"));
		oraclePage.addElement(new TextElement(
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
		...
		oraclePageStart.addAttribute(new Attribute("refid",
				"OracleDialectPrefix"));
		element.getElements().add(0, oraclePageStart);

		XmlElement oraclePageEnd = new XmlElement("include"); //$NON-NLS-1$     
		oraclePageEnd
				.addAttribute(new Attribute("refid", "OracleDialectSuffix"));
	...
	private void addPage(TopLevelClass topLevelClass,
		...
		method.addParameter(new Parameter(
				new FullyQualifiedJavaType(pageClass), name));
